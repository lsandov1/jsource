...
# gcc
common=" -fPIC -O1 -fwrapv -fno-strict-aliasing -Wextra -ftree-vectorize -fopt-info-vec-missed -Wno-maybe-uninitialized -Wno-unused-parameter -Wno-sign-compare -Wno-clobbered -Wno-empty-body -Wno-unused-value -Wno-pointer-sign -Wno-parentheses"
