...
# gcc
common=" -fPIC -O1 -fwrapv -fno-strict-aliasing -ftree-vectorize -fopt-info-vec-missed -Wextra -Wno-maybe-uninitialized -Wno-unused-parameter -Wno-sign-compare -Wno-clobbered -Wno-empty-body -Wno-unused-value -Wno-pointer-sign -Wno-parentheses"
